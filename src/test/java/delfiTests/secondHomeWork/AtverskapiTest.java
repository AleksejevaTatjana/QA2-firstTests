...
public class AtverskapiTest {
    ...
    private final By FIRST_SWEAMWEAR = By.xpath("//div[@class='card-info-title']");
    public final By FIRST_SWEAMWEAR_ITEM = By.xpath("//div[@class='col-xs-12']/h1");
    ...
    public void swimwearFilterTest() {
        ...
        String sweamwears = apaksvelaPeldkostimiPage.getSweamwearById(0);
        apaksvelaPeldkostimiPage.getSweamwearByID(0).getText().equals("PELDKOSTĪMS");
        String firstSweamwear= apaksvelaPeldkostimiPage.baseFunc.getElement(FIRST_SWEAMWEAR).getText();

        Assert.assertEquals("Item is not equels with sweamwear item", sweamwears, firstSweamwear);

        apaksvelaPeldkostimiPage.openSweamwearPage(0);

        FirstSweamwearPage firstSweamwearPage = new FirstSweamwearPage(baseFunc);
        String firstSweamwearItem = firstSweamwearPage.baseFunc.getElement(FIRST_SWEAMWEAR_ITEM).getText();


        Assert.assertEquals("Item on page FirstSweamwearPage is not equels with sweamwear item", firstSweamwear, firstSweamwearItem);
